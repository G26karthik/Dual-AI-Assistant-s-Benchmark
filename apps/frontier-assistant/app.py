...
import gradio as gr
from assistant import FRONTIER_SYSTEM_PROMPT, generate_frontier_response
...
LOGGER = StructuredLogger("frontier_assistant")
            ...
            with gr.Column(scale=3):
                ...
                chatbot = gr.ChatInterface(
                    ...
                    additional_inputs=[
                        enable_web_search,
                        show_reasoning,
                        gr.State(TokenBudgetMemory(system_prompt=FRONTIER_SYSTEM_PROMPT)),
